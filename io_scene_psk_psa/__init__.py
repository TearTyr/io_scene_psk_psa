...
if 'bpy' in locals():
    ...
    importlib.reload(psk_psa_panel)

else:
    # if i remove this line, it can be enabled just fine
    from .shared import data as psx_data
    from .shared import helpers as psx_helpers
    ...
    from .tool import psk_psa_panel
